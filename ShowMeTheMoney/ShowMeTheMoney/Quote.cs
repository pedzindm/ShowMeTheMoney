...
namespace ShowMeTheMoney
{
    public class Quote : INotifyPropertyChanged
    {
        ...
        private decimal averageDailyVolume=0;
        private decimal bid=0;
        private decimal ask=0;
        private decimal bookValue=0;
        private decimal changePercent=0;
        private decimal change=0;
        private decimal dividendShare=0;
        private DateTime lastTradeDate= DateTime.Today;
        private decimal earningsShare=0;
        private decimal epsEstimateCurrentYear=0;
        private decimal epsEstimateNextYear=0;
        private decimal epsEstimateNextQuarter=0;
        private decimal dailyLow=0;
        private decimal dailyHigh=0;
        private decimal yearlyLow=0;
        private decimal yearlyHigh=0;
        private decimal marketCapitalization=0;
        private decimal ebitda=0;
        private decimal changeFromYearLow=0;
        private decimal percentChangeFromYearLow=0;
        private decimal changeFromYearHigh=0;
        private decimal percentChangeFromYearHigh=0;
        private decimal lastTradePrice=0;
        private decimal fiftyDayMovingAverage=0;
        private decimal twoHunderedDayMovingAverage=0;
        private decimal changeFromTwoHundredDayMovingAverage=0;
        private decimal percentChangeFromFiftyDayMovingAverage=0;
        private string name="";
        private decimal open=0;
        private decimal previousClose=0;
        private decimal changeInPercent=0;
        private decimal priceSales=0;
        private decimal priceBook;
        private DateTime exDividendDate=DateTime.Today;
        private decimal pegRatio=0;
        private decimal priceEpsEstimateCurrentYear=0;
        private decimal priceEpsEstimateNextYear=0;
        private decimal shortRatio=0;
        private decimal oneYearPriceTarget=0;
        private decimal dividendYield=0;
        private DateTime dividendPayDate=DateTime.Today;
        private decimal percentChangeFromTwoHundredDayMovingAverage=0;
